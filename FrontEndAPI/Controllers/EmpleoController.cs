    ...
    public class EmpleoController : Controller
    {
        ...
        public IActionResult Index()
        {
            try
            {
                ...
                List<Models.EmpleoViewModel> empleo = JsonConvert.DeserializeObject<List<Models.EmpleoViewModel>>(content);
        ...
        public ActionResult Delete(Models.EmpleoViewModel empleo)
        {
            try
            {
                HttpResponseMessage response = serviceObj.DeleteResponse("api/empleo/" + empleo.EmpleoID.ToString());
                response.EnsureSuccessStatusCode();
